...
export const results: Result[] = [
  ...
  { id: 5, concern: "dark-spots", concernLabel: "Acne Scarring", timeline: "Week 1 → Week 8", weeksBefore: 1, weeksAfter: 8, productsUsed: [{ slug: "glow-cleansing-bar", name: "Glow Cleansing Bar" }, { slug: "vitamin-c-serum", name: "Vitamin C Serum" }], testimonial: "The scarring on my cheeks was so bad I wouldn't leave the house without makeup. Now my skin is clearing up beautifully.", customerName: "Destiny W.", image: "/results/result-5.jpg" },
  { id: 6, concern: "dark-spots", concernLabel: "Hyperpigmentation", timeline: "Week 1 → Week 6", weeksBefore: 1, weeksAfter: 6, productsUsed: [{ slug: "dark-spot-cream", name: "Dark Spot Cream" }, { slug: "nighttime-dark-spot-corrector", name: "Nighttime Dark Spot Corrector" }], testimonial: "My tone is so much more even now. The dark spots on my chin have faded dramatically.", customerName: "Crystal D.", image: "/results/result-6.jpg" },
  { id: 7, concern: "acne", concernLabel: "Acne & Breakouts", timeline: "Week 1 → Week 6", weeksBefore: 1, weeksAfter: 6, productsUsed: [{ slug: "blemish-corrector-kit", name: "Blemish Corrector Kit" }, { slug: "exfoliating-turmeric-scrub", name: "Exfoliating Turmeric Scrub" }], testimonial: "My skin has completely transformed. I feel confident going out without makeup now.", customerName: "Simone K.", image: "/results/result-7.jpg" },
  { id: 8, concern: "dark-spots", concernLabel: "Dark Spots & Scarring", timeline: "Week 1 → Week 8", weeksBefore: 1, weeksAfter: 8, productsUsed: [{ slug: "glow-cleansing-bar", name: "Glow Cleansing Bar" }, { slug: "dark-spot-cream", name: "Dark Spot Cream" }], testimonial: "The dark spots on my jawline have faded so much. I can finally see my natural skin again.", customerName: "Jasmine L.", image: "/results/result-8.jpg" },
];
