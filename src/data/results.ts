...
export const results: Result[] = [
  { id: 1, concern: "dark-spots", concernLabel: "Hyperpigmentation", timeline: "Week 1 → Week 6", weeksBefore: 1, weeksAfter: 6, productsUsed: [{ slug: "glow-cleansing-bar", name: "Glow Cleansing Bar" }, { slug: "dark-spot-cream", name: "Dark Spot Cream" }], testimonial: "I never thought my skin could look this even. The dark spots on my forehead are almost invisible now.", customerName: "Tamika R." },
  { id: 2, concern: "eczema", concernLabel: "Eczema", timeline: "Week 1 → Week 4", weeksBefore: 1, weeksAfter: 4, productsUsed: [{ slug: "eczema-oatmeal-bar", name: "Eczema Oatmeal Bar" }, { slug: "eczema-pudding-cream", name: "Eczema Pudding Cream" }], testimonial: "My arms were so inflamed before. Now the itching is gone and my skin is smooth again.", customerName: "Keisha M." },
  { id: 3, concern: "acne", concernLabel: "Acne & Breakouts", timeline: "Week 1 → Week 8", weeksBefore: 1, weeksAfter: 8, productsUsed: [{ slug: "blemish-corrector-kit", name: "Blemish Corrector Kit" }, { slug: "turmeric-mud-mask", name: "Turmeric Mud Mask" }], testimonial: "My chin was a mess. Now I actually feel confident going out without makeup.", customerName: "Aaliyah T." },
  { id: 4, concern: "dark-spots", concernLabel: "Sun Damage", timeline: "Week 1 → Week 10", weeksBefore: 1, weeksAfter: 10, productsUsed: [{ slug: "vitamin-c-serum", name: "Vitamin C Serum" }, { slug: "nighttime-dark-spot-corrector", name: "Nighttime Dark Spot Corrector" }], testimonial: "Years of sun damage on my cheeks. Two products and 10 weeks later — I'm amazed.", customerName: "Monica J." },
